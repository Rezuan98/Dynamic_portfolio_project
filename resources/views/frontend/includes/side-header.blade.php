<header id="header" class="header dark-background d-flex flex-column">
    ...
    <div class="profile-img">
      ...
      <img src="{{ asset('storage/' . $userinfo->profile_image) }}" height="50px";  style="" alt="" class="img-fluid rounded-circle">
    </div>

    <a href="index.html" class="logo d-flex align-items-center justify-content-center">
      <!-- Uncomment the line below if you also wish to use an image logo -->
      <img src="{{asset('frontendAsset/assets/img/logo.png')}}" alt=""> 
      <h1 class="sitename">{{ $userinfo->name }}</h1>
    </a>
    ...
    <div class="social-links text-center">
      ...
      <a href="https://google.com" class="google-plus"><i class="bi bi-skype"></i></a>
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li><a href="{{ route('home') }}"><i class="bi bi-hdd-stack navicon"></i> Services</a></li>
        ...
        <li><a href="#contact"><i class="bi bi-envelope navicon"></i> Give Me a Message</a></li>
      </ul>
    </nav>
