...
<div class="container mt-4">
    <h2 style="margin-top: 50px;margin-bottom:30px">Services I provide</h2>
            ...
            <thead class="table-dark">
                ...
                <tbody>
                    ...
                    <tr id="item-{{ $item->id }}">  <!-- Unique ID for each row -->
                       ...
                       <td>
                        <a href="{{route('edit.services',['id' => $item->id])}}" class="btn btn-success">edit</a>
...
<script>
    $(document).on('click', '.btn-delete', function(e) {
        ...
        var url = "{{ route('delete.services', '') }}/" + id;  // Construct the URL with the route
